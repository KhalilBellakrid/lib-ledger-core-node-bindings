...
declare class NJSCosmosLikeTransaction
{
    ...
    declare function getReceiver(): ?NJSCosmosLikeAddress;
    /** Get Cosmos. sender address */
    declare function getSender(): NJSCosmosLikeAddress;
    ...
    declare function getGasAdjustment(): number;
}
...
declare class NJSCosmosLikeTransactionBuilder
{
     ...
     */
    declare function sendToAddress(amount: NJSAmount, address: string): NJSCosmosLikeTransactionBuilder;
    /**
     * Send all available funds to the given address.
     * @param address Address of the recipient
     * @return A reference on the same builder in order to chain calls.
     */
    declare function wipeToAddress(address: string): NJSCosmosLikeTransactionBuilder;
    /**
     * Set gas limit the originator is not willing to exceed.
     * @return A reference on the same builder in order to chain calls.
     */
    declare function setGasLimit(gasLimit: NJSAmount): NJSCosmosLikeTransactionBuilder;
    declare function setGasPrice(gasPrice: NJSAmount): NJSCosmosLikeTransactionBuilder;
...
declare class NJSNetworks
{
    ...
    static declare function cosmos(): CosmosLikeNetworkParameters;
}
